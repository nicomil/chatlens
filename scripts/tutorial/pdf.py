...
def main(argv=None) -> int:
    ...
    # Nothing here asserts what the figures are of. This used to print "on a
    # synthetic study generated by chatlens demo. Nobody's data." above them,
    # which was true when it was written and became false the moment the guide
    # was re-shot on a real study — a claim about whose conversations these are
    # must come from the guide, which knows, and not from the converter, which
    # does not.
    title, body = guide()
